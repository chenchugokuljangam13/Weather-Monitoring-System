...
SECRET_KEY = 'django-insecure-e8659^t=yywts2tb46%o-3*u50m6ig$&4sr5d%4#e%t61r87db'
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'  # For testing; use SMTP for production
